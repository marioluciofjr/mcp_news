...
def acesso(
	...
	Esse placeholder será o argumento na tool 'search_news'.

	A partir das informações coletadas pela tool 'search_news', você criará um resumo com o seguinte formato:

	# Título da notícia

	parágrafo 1: Resumo da notícia, incluindo os principais pontos e informações relevantes.
	parágrafo 2: Contexto adicional, como a importância da notícia e possíveis implicações futuras.
